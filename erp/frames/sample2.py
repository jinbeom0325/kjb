...
class SampleFrame2(tk.Frame):
    def __init__(self, root):
        ...
        self.ca_21 = DateEntry(self.frame2, selectmode='day', width=15, style="DateEntry.TEntry")
        self.ca_22 = DateEntry(self.frame2, selectmode='day', width=15, style="DateEntry.TEntry")
        ...
        self.ca_21.grid(row=1, column=1, padx=5, pady=10)
        self.ca_22.grid(row=1, column=2, padx=5, pady=10)
